    ...
    return (
        <>
                ...
                <div className='search-text'>
                    <input type="text" placeholder='Nhập Tiêu Đề ...' value={searchText} onChange={(e)=>setSearchText(e.target.value)} style={{color: 'white'}}/>
                ...
                {selectedFilter[check].type==='all'&&(
                    <FilterDiv>
                        <FilterList>
                            <button style={{border: show?'1px dotted #acacac':'1px solid #cacaca', backgroundColor: show?'#000':'#171717', color: 'white'}}>
                                <p onClick={(e)=>{
                                    e.stopPropagation();
                                    setShow(prev=>!prev);
